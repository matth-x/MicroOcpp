...
class CustomOperation : public Operation, public AllocOverrider {
private:
    MemString operationType;
    ...
    std::function<std::unique_ptr<MemJsonDoc> ()> fn_getErrorDetails; //optional
public:
    ...
    CustomOperation(const char *operationType,
            ...
            std::function<std::unique_ptr<MemJsonDoc> ()> fn_getErrorDetails = nullptr);
